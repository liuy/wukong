...
func TestTensorMatmul(t *testing.T) {
	...
	// TODO: support f16 as output for Q8_0
	// row := 4
	// col := 32
...
func TestTensorEmbedding(t *testing.T) {
	...
	assert.NoErr(t, err)
	expected := []int16{
		15368, 16392, 16908, 17416, 17674, 17932, 18190, 18440, 18569, 18698, 18827, 18956, 19085, 19214, 19343, 19464, 19512, 19577,
		19641, 19706, 19770, 19835, 19899, 19964, 20028, 20093, 20157, 20222, 20286, 20351, 20415, 20480, 0, -24320, 9472, -22656,
		10496, -21952, 11216, -21368, 11560, -21048, 11880, -20728, 12200, -20444, 12404, -20284, 12584, -20104, 12744, -19944, 12904,
		-19784, 13064, -19624, 13224, -19464, 13358, -19370, 13438, -19290, 13518, -19210,
	}
	assert.Equal(t, expected, r.ToHost().([]int16))
}
